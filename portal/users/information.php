                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text"><a href="#">naomisoi@gmail.com</a></span>
                                                </li>
                                                <li>
                                                    <span class="title">Phone:</span>
                                                    <span class="text">+254 746 038221</span>
                                                </li>
                                                <li>
                                                    <span class="title">Address:</span>
                                                    <span class="text">NTP Nairobi, Kenya</span>
                                                </li>
                    ...
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <div class="experience-box">
                               <p>The online emergency management system designed and implemented for Kenya is aimed at improving the country's emergency response capabilities. The system includes features such as real-time communication and messaging, resource management, mapping and geospatial analysis, automated alerts, and data management and reporting. The system architecture consists of three layers:<br>
                               1. Presentation <br>
                               2. Application <br>
                               3. Data <br>
                               This program is developed using HTML/CSS, JavaScript, for frontend while the backend is build on PHP, and MySQL. The system was tested using unit testing, integration testing, and system testing to ensure it met the requirements and specifications outlined in the system design. The successful implementation of this system is expected to lead to a more efficient and effective emergency management system in Kenya, ultimately saving lives and minimizing the impact of disasters.</p>
